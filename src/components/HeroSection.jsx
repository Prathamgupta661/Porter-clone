...
const cities = [
  'Bangalore', 'Delhi NCR', 'Mumbai', 'Hyderabad', 'Ahmedabad', 'Pune', 'Kolkata', 'Chennai', 'Surat', 'Jaipur',
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-40 right-20 w-16 h-16 bg-cyan-400/10 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
        <div className="absolute bottom-20 left-1/4 w-12 h-12 bg-purple-400/10 rounded-full animate-float" style={{animationDelay: '4s'}}></div>
        <div className="absolute top-1/3 right-1/3 w-24 h-24 bg-yellow-400/10 rounded-full animate-float" style={{animationDelay: '1.5s'}}></div>
      </div>
          ...
          <div className={`lg:col-span-4 ${isVisible ? 'animate-slide-in-up' : ''}`}>
            <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl text-gray-800 p-6 md:p-8 border border-white/20 relative">
              ...
              <div className="flex items-center space-x-3 border-b border-gray-200 pb-4 mb-6">
                ...
                <select
                  className="font-bold flex items-center focus:outline-none text-base hover:text-blue-600 transition-colors duration-200 bg-transparent"
                  value={selectedCity}
